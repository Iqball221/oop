    ...
    <form action="" method="post">
        ...
        <table>
            ...
            <tr>
                <td>Hobi : </td>
                <td>
                    <input type="checkbox" name="hobi[]" value="Bersih-bersih">Bersih-bersih<br>
                    <input type="checkbox" name="hobi[]" value="Holiday">Holiday<br>
                    <input type="checkbox" name="hobi[]" value="karate">Menyanyi<br>
                    <input type="checkbox" name="hobi[]" value="kungfu">Menari <br>
